...
"""
mutable struct HandleEventMachine <: HSM.AbstractHsmState
    parent::Union{HSM.AbstractHsmState, Nothing}
    active_state::Union{HSM.AbstractHsmState, Nothing}
    handled_event::Bool
    
    function HandleEventMachine(parent, active_state, handled_event)
...
HandleEventMachine(parent) = HandleEventMachine(parent, nothing, false)

# HandleEventMachineState event handlers.
...
@testset "handle_event() -- HSM guards against unhandled events." begin
    machine = HandleEventMachine(nothing)
